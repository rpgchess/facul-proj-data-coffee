...
<body>
	...
	<div class="container">
		<form action="login-valid" method="post" class="form-signin">
        	<h2 class="form-signin-heading">Faça o login</h2>
        	<label for="inputLogin" class="sr-only">Login</label>
        	<input type="text" id="inputLogin" name="user" class="form-control" placeholder="Login" required autofocus>
        	<label for="inputPassword" class="sr-only">Senha</label>
        	<input type="password" id="inputPassword" name="pwd" class="form-control" placeholder="Senha" required>
